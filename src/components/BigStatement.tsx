  ...
  <div className="bg-primary pt-[60px] pb-[20px] md:pt-[100px] md:pb-[40px] relative overflow-hidden flex flex-col items-center justify-center">
    ...
    <div className="w-full relative z-10 overflow-hidden flex">
      <div className="animate-marquee-left hover:[animation-play-state:paused] cursor-default">
        {[...Array(8)].map((_, i) => (
          <div key={i} className="flex items-center gap-6 px-3 md:gap-10 md:px-5 font-heading text-[clamp(50px,8vw,140px)] tracking-[2px] md:tracking-[4px] leading-none">
            <span className="text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.2)]">DOING <span className="hidden md:inline">IS GREATER</span></span>
            <span className="md:hidden text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.2)]">IS GRTR</span>
    ...
    <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-[60px] mt-20 md:mt-32">
      ...
      <div className="font-heading text-[clamp(45px,8vw,110px)] leading-[0.85] reveal drop-shadow-md">
