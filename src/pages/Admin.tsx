                        ...
                        <div className="space-y-8 relative">
                          {timelineEvents.map((event, idx) => (
                            <div key={idx} className="relative flex flex-col md:flex-row gap-6 md:gap-12 group">
                               ...
                               {/* Content Card */}
                               <div className="flex-1 bg-[#111] border border-white/5 p-6 hover:border-white/10 transition-colors ml-8 md:ml-0 relative z-20">
                                  ...
                                  <h3 className="text-xl font-bold text-white tracking-wide mb-2">{event.title}</h3>
                                  {event.eventType === 'test' && event.details && (
                                    <p className="text-sm text-white/50 leading-relaxed">{event.details}</p>
                                  )}
